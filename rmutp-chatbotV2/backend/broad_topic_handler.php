...
class BroadTopicHandler {
    ...
    private static $topicDefinitions = [
        ...
        [
            'id' => 'curriculum',
            'keywords' => ['หลักสูตร', 'แผนการเรียน', 'เรียนอะไร'],
            'title' => '📚 หลักสูตร / แผนการเรียน',
            'type' => 'department',
            'categories' => ['curriculum', 'program'],
            'searchTerms' => ['หลักสูตร', 'แผนการเรียน', 'เปิดสอน', 'เรียนอะไร', 'ปริญญา', 'วิชา'],
    ...
    public static function searchRelatedFAQs($topic, $db) {
        ...
        // 2. เสริมด้วย category (ถ้ามี และเป็น faq_list type)
    ...
    private static function buildDepartmentOverview($topic, $faqs) {
        ...
        $mainKeyword = $searchTerms[0] ?? $topic['keywords'][0] ?? '';
