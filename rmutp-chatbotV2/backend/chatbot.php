...
class Chatbot {
    ...
    private function searchFAQBroad($query, $filterCategory = null) {
        ...
        if ($filterCategory) {
            ...
            $relatedCategories = [
                'program' => ['curriculum', 'about', 'general', 'activities', 'contact', 'admission'],  // หลักสูตร↔รายวิชา↔เกี่ยวกับ↔กิจกรรม(สหกิจ)↔ติดต่อ↔การรับสมัคร
                'curriculum' => ['program'],
                'about' => ['program', 'general', 'contact'],
                'general' => ['about', 'document', 'cooperation', 'staff', 'facilities', 'research', 'activities', 'contact'],  // general=catch-all → AI มักจำแนกผิดเป็น general
