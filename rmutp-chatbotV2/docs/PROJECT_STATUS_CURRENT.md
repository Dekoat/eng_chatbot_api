...
### 2. FAQ System
- ✅ 577 FAQ รายการ (ปรับ merge categories + ลบ FAQ ที่ซ้ำซ้อน)
- ✅ ครอบคลุม 10 สาขาวิศวกรรม
- ✅ 16 departments, 15 categories
- ✅ Training Data: 3,466 records, 17 intents
- ✅ **Accuracy 100%** (577/577 FAQs ทดสอบผ่านหมด)
- ✅ Refactored code: แยก config → ChatbotConfig.php, query analysis → QueryAnalyzer.php
...
│
├── backend/
│   ├── chatbot.php               # Main Chat API (refactored v2.0)
│   ├── ChatbotConfig.php         # ค่าคงที่ + config ทั้งหมด
│   ├── QueryAnalyzer.php         # วิเคราะห์คำถาม (normalize, synonyms, intent)
│   ├── generic_question_handler.php
│   ├── db.php / security.php
...
### 9 กุมภาพันธ์ 2026 ⭐ (Refactoring)
- **Refactored chatbot.php** (2,366 → 1,359 บรรทัด)
  - แยก ChatbotConfig.php (561 บรรทัด) — ค่าคงที่ + config ทั้งหมด
