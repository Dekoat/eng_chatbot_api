...
### 1.3 ขอบเขตของระบบ (Scope)
ครอบคลุม: รายชื่ออาจารย์ 118 คน (10 สาขา), FAQ 598 รายการ (16 หมวดหมู่), ข่าว/กิจกรรม 33 รายการ, AI/ML Intent Classification (TF-IDF + Logistic Regression (C=10), 96.4% accuracy), Admin Dashboard, การโต้ตอบผ่านเว็บ (Browser)
...
ระบบสามารถตอบคำถามได้ครอบคลุมทั้ง FAQ (577 รายการ, 15 หมวด, Accuracy 100%), บุคลากร (118 คน), และข่าวสาร (33 รายการ) รองรับภาษาไทยและคำย่อที่พบบ่อย ใช้ Hybrid approach (AI Intent Classification + Rule-based FAQ Matching) ทำให้ได้ทั้งความเข้าใจบริบทและข้อมูลจริงจากฐานข้อมูล โครงสร้างข้อมูลมีความสะอาดหลังปรับมาตรฐานชื่อสาขา เวลาตอบสนองอยู่ในระดับเหมาะสมสำหรับการใช้งานเบื้องต้น Backend ได้รับการ Refactor เป็น 3 ไฟล์ (ChatbotConfig, QueryAnalyzer, chatbot) รวม 2,106 บรรทัด ดูแลรักษาง่าย
