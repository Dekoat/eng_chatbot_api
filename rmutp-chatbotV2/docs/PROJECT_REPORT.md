...
### 1.3 ขอบเขตของระบบ (Scope)
ครอบคลุม: รายชื่ออาจารย์ 118 คน (10 สาขา), FAQ 598 รายการ (16 หมวดหมู่), ข่าว/กิจกรรม 30 รายการ, AI/ML Intent Classification (TF-IDF + Logistic Regression (C=10), 96.4% accuracy), Admin Dashboard, การโต้ตอบผ่านเว็บ (Browser)
...
- FAQ Accuracy: 598/598 (100%) + Variant 659/659 (100%) ผ่านการทดสอบ
