...
### 1.3 ขอบเขตของระบบ (Scope)
ครอบคลุม: รายชื่ออาจารย์ 118 คน (10 สาขา), FAQ 577 รายการ (15 หมวดหมู่), ข่าว/กิจกรรม 33 รายการ, AI/ML Intent Classification (TF-IDF + Logistic Regression (C=10)), Admin Dashboard, การโต้ตอบผ่านเว็บ (Browser)
...
- FAQ Accuracy: 577/577 (100%) ผ่านการทดสอบ
