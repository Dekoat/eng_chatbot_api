...
### 1.3 ขอบเขตของระบบ (Scope)
ครอบคลุม: รายชื่ออาจารย์ 118 คน (10 สาขา), FAQ 593 รายการ (17 หมวดหมู่), ข่าว/กิจกรรม 30 รายการ, AI/ML Intent Classification (TF-IDF + Logistic Regression (C=10), 96.4% accuracy), Admin Dashboard, การโต้ตอบผ่านเว็บ (Browser)
...
### 1.5 ข้อจำกัดของระบบ (Limitations)
- ใช้ Hybrid approach: AI (TF-IDF + Logistic Regression (C=10)) สำหรับ Intent Classification + Rule-based สำหรับ FAQ Matching
- FAQ Accuracy: 593/593 (100%) + Variant 659/659 (100%) ผ่านการทดสอบ
- ไม่รองรับหลายภาษา (รองรับไทยเป็นหลัก)
- คุณภาพคำตอบขึ้นกับความครบถ้วนของฐานข้อมูล
- Admin Dashboard ระดับ MVP รองรับ CRUD หลัก
...
├─ backend/  (API & NLP)         ─ chatbot.php (1,359), ChatbotConfig.php (561), QueryAnalyzer.php (186)
├─ database/ (SQL scripts)       ─ import_faq_sime.sql
├─ ai/       (ML Module)         ─ Flask API, train/test scripts, models
├─ scripts/  (utility)           ─ คู่มือการใช้งาน
├─ docs/     (reports)           ─ PROJECT_REPORT.md, THEORY.md
...
### 4.1 เทคโนโลยีและเครื่องมือ
- Backend: PHP 8.2+, PDO (Refactored v3.0 — 3 ไฟล์, 2,106 บรรทัด)
- Database: MySQL/MariaDB (utf8mb4), FAQ 577 รายการ, Staff 118 คน
- AI/ML: Python Flask + TF-IDF + Logistic Regression (C=10) (17 intents, 3,466 training data)
...
ระบบสามารถตอบคำถามได้ครอบคลุมทั้ง FAQ (593 รายการ, 17 หมวด, Accuracy 100%), บุคลากร (118 คน), และข่าวสาร (30 รายการ) รองรับภาษาไทยและคำย่อที่พบบ่อย ใช้ Hybrid approach (AI Intent Classification + Rule-based FAQ Matching) ทำให้ได้ทั้งความเข้าใจบริบทและข้อมูลจริงจากฐานข้อมูล โครงสร้างข้อมูลมีความสะอาดหลังปรับมาตรฐานชื่อสาขา เวลาตอบสนองอยู่ในระดับเหมาะสมสำหรับการใช้งานเบื้องต้น Backend ได้รับการ Refactor เป็น 4 ไฟล์ (ChatbotConfig, QueryAnalyzer, chatbot, BroadTopicHandler) รวม 3,958 บรรทัด ดูแลรักษาง่าย

---
## บทที่ 7 ข้อเสนอแนะและการพัฒนาต่อยอด
ระยะสั้น: เพิ่ม FAQ ตามหมวดใหม่ / ปรับปรุงคำพ้อง / เพิ่ม Analytics เชิงลึก
ระยะกลาง: รองรับ Multi-language / Dashboard ผู้ดูแล / Multi-channel (LINE/Facebook)
ระยะยาว: นำโมเดลภาษาไทย (Deep Learning / Transformer) มาทำ Intent Classification และ Semantic Search / รองรับเสียง / รองรับ Mobile App
...
**ปรับปรุงล่าสุด:** 9 กุมภาพันธ์ 2026  
**เวอร์ชันรวมเล่ม:** 3.0 (Refactored)
